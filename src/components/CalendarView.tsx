  ...
  return (
    <div className="cal-outer">
      ...
      >
        ...
        {/* corner for row 1 */}
        <div style={{ gridColumn: 1, gridRow: 1, position: "sticky", top: 0, left: 0, zIndex: 5, background: "var(--surface)", minWidth: 40 }} />
        {weekOrder.map(wk => (
          <div
            key={wk}
        ...
        {/* corner for row 2 */}
        <div style={{ gridColumn: 1, gridRow: 2, position: "sticky", top: WEEK_ROW_H, left: 0, zIndex: 5, background: "var(--surface)", borderBottom: "1px solid var(--border)", minWidth: 40 }} />
        {allDays.map(dayKey => {
